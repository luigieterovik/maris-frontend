    ...
    <S.Container>
      ...
      <S.Main>
        ...
        <S.Footer>
          ...
          <S.FooterItem style={{ fontSize: '15px' }}>ENTRAR EM CONTATO (E-MAIL)</S.FooterItem> <br />
          <S.FooterItem style={{ fontSize: '15px' }}>+55 (11) 99556-4108 (WHATSAPP)</S.FooterItem>

          <S.FooterItem>Nós aceitamos</S.FooterItem>
        </S.Footer>
      </S.Main>
    </S.Container>
  )
